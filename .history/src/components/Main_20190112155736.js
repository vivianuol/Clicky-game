    ...
    render() {
        return (
            <div className="container">
                ...
                <img src={require("./assets/images/pinocchino.png")} alt="pinocchino" height="240" width="240"></img>
                <img src={require("./assets/images/Sponge-Bob.png")} alt="Sponge-Bob" height="240" width="240"></img>
                <img src={require("./assets/images/Spongebob-Squarepants.png")} alt="Sponge-Bob" height="240" width="240"></img>
